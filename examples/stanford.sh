#!/usr/bin/env bash
# Teacher
python run.py --dataset stanford --epochs 40 --lr_decay_epochs 25 30 35 --iter_per_epoch 1000  --lr_decay_gamma 0.5 \
              --base resnet50 --embedding_size 512 --sample distance --margin 0.2 --save_dir stanford_resnet50_512

# Student with small embedding
python run_distill.py --dataset stanford --epochs 120 --iter_per_epoch 500 --lr_decay_epochs 40 80 --lr_decay_gamma 0.1 \
